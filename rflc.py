...
AUTH   = 'XpGLLsepRjytGIZiRUDUhjmA'
USERID = '50eba277aaa5cd40db5c1ec4'
...
t = threading.Timer(5, toStage)
t.start()

#def afk():
#    bot.pm('\/afk','50f097bdaaa5cd4d3ca6c999')

#bot.on('registered', afk)
